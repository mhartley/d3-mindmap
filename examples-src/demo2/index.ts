...
const onJsonUpdate = (jsonData) => {
  let newValue = tidy(jsonData);
  editorEl.value = newValue;
  console.log("Updated JSON: ", jsonData);
}

const renderMindMapFromData = MindMap(mindmapEl, onJsonUpdate);
function render() {
  if (onType === 'default') {
    return renderMindMapFromData(value);
  }
  return renderMindMapFromData(formatJSON(value));
}
        ...
        "children": [
              ...
              {"name": "The Filling Component",
                "children": [
                  ...
                  {"name": "The secondary ingredient",
                    "children": [
                      {"name": "If a sandwich has just one ingredient, it must be meat or cheese"}
                    ]
                  },
          ...
          },
          {
            ...
            "children": [
              ...
              {
                "name": "The Bread Must be baked before a sandwich is made"
              }
            ]
          },
          {
